...
export class CoreTables1730870533717 implements MigrationInterface {
    name = 'CoreTables1730870533717'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "company_contact" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "dni" character varying NOT NULL, "names" character varying NOT NULL, "lastname" character varying NOT NULL, "second_lastname" character varying NOT NULL, "academic_degree" character varying NOT NULL, "position_representative" character varying NOT NULL, "phone" character varying NOT NULL, "email" character varying NOT NULL, "company_id" uuid, CONSTRAINT "PK_83805404ba83a62bac85a4a479f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "internship_document" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "approval_status" "public"."internship_document_approval_status_enum" NOT NULL DEFAULT 'pending', "document_url" character varying NOT NULL, "internship_id" uuid, "document_type_id" uuid, CONSTRAINT "PK_0b2aadd7f968ac3926da1523840" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."internship_status_enum" AS ENUM('pending', 'approved', 'rejected')`);
        await queryRunner.query(`CREATE TABLE "internship" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "start_date" TIMESTAMP NOT NULL, "end_date" TIMESTAMP NOT NULL, "position" character varying NOT NULL, "description" character varying NOT NULL, "hours" integer, "status" "public"."internship_status_enum" NOT NULL DEFAULT 'pending', "student_id" uuid, "company_id" uuid, CONSTRAINT "PK_dd14a64bcc5e8b5843a2764915a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying, "templateUrl" character varying NOT NULL, CONSTRAINT "PK_515948649ce0bbbe391de702ae5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "internship_document" ADD CONSTRAINT "FK_6f3eb69fbc6370a045aac84f3a7" FOREIGN KEY ("document_type_id") REFERENCES "document_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "internship_document" DROP CONSTRAINT "FK_6f3eb69fbc6370a045aac84f3a7"`);
